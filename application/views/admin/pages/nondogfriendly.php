...
<section class="content">
    ...
    <div class="col-xs-12">
        ...
        <div class="box-header">
            <h3 class="box-title">Non DogFriendlys</h3></p>
            <br><br><h3 class="box-title">Place: <?php echo $data['place']; ?></h3>
            <h3 class="box-title">Address: <?php echo $data['address']; ?></h3>
            <h3 class="box-title">Total: <?php echo $data['total']; ?></h3>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <button type="button" class="btn btn-danger delete-nondogfriendly">Delete</button>
            </div>
        </div>
        <!-- /.modal-content -->
    </div>
